    ...
    <>
      ...
      >
        <section className="flex  items-center ">
          <article className="mx-auto text-center w-4/5 md:w-9/12 mb-15 flex flex-col items-center bg-yellow-500">
            <h2 className="text-5xl text-center font-unica p-2">
              Hamburguesas
            </h2>
            <figure className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  md:justify-items-center w-6/6 gap-3 pb-20">
